...
using System.Linq;
using CppSharp.AST;
using Kedacom.AutoGen.CppSharpUnsafeGenerator.Definitions;
using MacroDefinition = Kedacom.AutoGen.CppSharpUnsafeGenerator.Definitions.MacroDefinition;

namespace Kedacom.AutoGen.CppSharpUnsafeGenerator.Processors
{
